...
/**
 * A custom exception class to express the error
 * that memory upload couldn't be completed
 * @author swaroop_nath
 *
 */
public class UploadNotCompleteException extends Exception {
	 ...
	 */
	public UploadNotCompleteException(String message, HttpStatus status) {
		super(message);
		this.status = status;
	}
